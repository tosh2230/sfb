...
class TestBigQueryConfig:
    ...
    def test_set_config_query_params_type(self, bigquery_config_set):
        assert type(bigquery_config_set.query_parameters[0]) is ScalarQueryParameter
    ...
    def test_set_config_query_params_parameterType(self, bigquery_config_query_params):
        assert bigquery_config_query_params[0]['parameterType']['type'] == 'DATE'

    def test_set_config_query_params_parameterValue(self, bigquery_config_query_params):
        assert bigquery_config_query_params[0]['parameterValue']['value'] == '2020-01-01'
